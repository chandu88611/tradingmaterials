          ...
          <div className="col-xxl-12">
             <div className="breadcrumb__content p-relative z-index-1 pb-20 d-flex align-items-center justify-content-between">
                ...
                <div className="profile__main-logout text-sm-end">
                   <a href="login.html" className="tp-logout-btn"><i className="fa-solid fa-house-chimney"></i> Home</a>
                </div>
             </div>
          </div>
       </div>
                      ...
                      <div className="">
                         <div className="row">
                            <div className="col-12 col-md-12 col-lg-6 border-right">
                               <div className="profile__address-item">
                                  <div className="profile__address-content">
                                     <h3 className="profile__address-title text-info">Contact Info</h3>
                                     <div className=" border-bottom-light p-1">
                                        <p className="mb-0"><span>Name</span></p>
                                     ...
                                     <div className=" border-bottom-light p-1">
                                        <p className="mb-0"><span>Phone</span></p>
                               ...
                               <div className="profile__address-item mt-20">
                                  <div className="profile__address-content">
                                     <h3 className="profile__address-title text-info">Order Info</h3>
                                     <div className=" border-bottom-light p-1">
                                        <p className="mb-0"><span>Order ID</span></p>
                                        <p className="mb-0">PROD5202</p>
                                     </div>
                                     <div className=" border-bottom-light p-1">
                                        <p className="mb-0"><span>Order Date</span></p>
                                        <p className="mb-0">10th June, 2023</p>
                                     </div>
                                     <div className=" border-bottom-light p-1">
                                        <p className="mb-0"><span>Estimated Delivery</span></p>
                                        <p className="mb-0 text-primary">15th June, 2023</p>
                                     </div>
                                  </div>
                               </div>
                            </div>
                            <div className="col-12 col-md-12 col-lg-6">
                               <div className="profile__address-item">
                                  <div className="profile__address-content">
                                     <h3 className="profile__address-title text-info">Shipping Address</h3>
                                     <div className="row">
                                        <div className="col-12 col-lg-12 border-bottom-light p-1">
                                           <p className="mb-0"><span>Address Line 1</span></p>
                                           <p className="mb-0">3rd F Cross, 401, level-4 ragavs building</p>
                                        </div>
                                        <div className="col-12 col-lg-12 border-bottom-light p-1">
                                           <p className="mb-0"><span>Address Line 2</span></p>
                                           <p className="mb-0">Ramamurthy nagar</p>
                                        </div>
                                        <div className="col-12 col-lg-6 border-bottom-light border-right-light p-1">
                                           <p className="mb-0"><span>City</span></p>
                                           <p className="mb-0">Bengaluru</p>
                                        </div>
                                        <div className="col-12 col-lg-6 border-bottom-light p-1">
                                           <p className="mb-0"><span>State</span></p>
                                           <p className="mb-0">Karnataka</p>
                                        </div>
                                        <div className="col-12 col-lg-6 border-bottom-light border-right-light p-1">
                                           <p className="mb-0"><span>Country</span></p>
                                           <p className="mb-0">India</p>
                                        </div>
                                        <div className="col-12 col-lg-6 border-bottom-light p-1">
                                           <p className="mb-0"><span>Zip code</span></p>
                ...
                <div className="profile__main shadow h-100">
                   <div className="profile__main-top p-20">
                      <div className="text-center">
                         ...
                         <img src="https://www.asiaticpack.com/wp-content/uploads/2022/12/box-animation.gif" width="175px"/>
                      </div>
                      <div className="">
                         <p className="text-center text-info mb-5" style={{lineHeight: 1.25}}><b>Successful!</b><br/> We have received your advance payment, we are packing your order to be shipped to your doorstep.</p>
                         <div className="row">
                            ...
                            <div className="col-12 col-lg-6 border-bottom-light">
                               ...
                               <p className="detail-desc mb-0">Trading Material Mouse Pad</p>
                            </div>
                            <div className="col-12 col-lg-6 border-bottom-light border-right-light">
                            ...
                            <div className="col-12 col-lg-6 border-bottom-light">
                               <p className="detail-title mb-0"><b>Balance : </b></p>
                               <p className="detail-desc mb-0"><b>₹10,500</b></p>
                            </div>
                         </div>
                    
                         <p className="text-center text-orange mb-0 mt-15"><b>Note : </b> Balance amount to be paid once you recieve the product as COD.</p>
                      </div>
                   </div>
                </div>
             </div>
