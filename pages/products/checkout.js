    ...
    try {
      const response = await axios.post(
        "https://admin.tradingmaterials.com/api/lead/product/checkout/place-order",
        {
          ...
          disc_percent: promoDetails?.disc_percent
            ? promoDetails?.disc_percent
            : 0,
            ...
            <div className="row">
              <div className="col-lg-7">
                <div className="tp-checkout-bill-area">
                  <h3 className="tp-checkout-bill-title">Contact Details</h3>
                ...
                <div className="tp-checkout-place white-bg">
                  ...
                  <div className="tp-order-info-list">
                    <ul>
                      ...
                      {user?.cart.map((data, i) => (
                        <li className="tp-order-info-list-desc" key={i}>
                      ...
                      <li className="tp-order-info-list-total">
                        <span>Discount</span>
                        <span>
                          ₹{promoDetails?.discount ? promoDetails?.discount : 0}
                        </span>
                      </li>{" "}
                      <li className="tp-order-info-list-total">
                        <span>Total</span>
                        <span>
                          ₹{promoDetails?.total ? promoDetails?.total : total}
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="tp-checkout-payment">
                    {user?.payment_types.map((data, id) => (
                      <div className="tp-checkout-payment-item" key={id}>
