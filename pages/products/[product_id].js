              ...
              <div className="row">
                <div className="col-xl-7 col-lg-6 ">
                  <div className=" tp-tab d-sm-flex">
                    <nav>
                      <div
                        className="nav nav-tabs flex-sm-column mb-2 gap-2 "
                      ...
                      >
                        {img.map((data, index) => (
                          <button
                            key={index}
                            style={{
                              border: data === imgMain ? "2px solid gray" : "",
                            }}
                            id="nav-1-tab"
                            type="button"
                            onClick={() => setImgMain(data)}
                          >
                    ...
                    <div
                      className="tab-content m-img sm:ml-3"
                ...
                <div className="col-xl-5 col-lg-6">
                  <div className="tp-product-details-wrapper">
                    ...
                    <div className="tp-product-details-action-wrapper">
                      ...
                      <div className="tp-product-details-action-item-wrapper d-flex align-items-center">
                        ...
                        <div className="tp-product-details-add-to-cart mb-15 w-100">
                          <button
                            ...
                            onClick={() =>
                              checkUser(produc?.id, "hj", produc?.img_1)
                            }
                          >
                            {loader ? (
                      ...
                      <div className="tp-product-details-action-sm mt-2">
                        <button
                          ...
                          onClick={() => checkUser(produc?.id, "wish")}
                        >
                          <svg
                            width="17"
                            height="16"
                    ...
                    <button
                      className=" w-100 mt-5 ml-[-2px] btn1"
                      onClick={() => checkUser(produc?.id, "buy")}
                    >
                      Buy Now
                    </button>
                  </div>
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="tp-product-details-tab-nav tp-tab ">
                    <nav>
                      <div
                        className="nav nav-tabs p-relative tp-product-tab gap-5"
                      ...
                      >
                        ...
                        <button
                          onClick={() => setActiveButton("similarproducts")}
                          className={`nav-link ${
                            activeButton === "similarproducts" ? "active" : ""
                          }`}
                        >
                          Similar Products
                        </button>
                    ...
                    <div>
                      {activeButton === "description" && (
                        <div className=" md:ml-30  pt-10 fadein">
                          <div
                            dangerouslySetInnerHTML={{
