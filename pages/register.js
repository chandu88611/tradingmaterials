...
const schema = yup
  .object({
    ...
    phone: yup
      ...
      .min(10, "The Number must be 10 characters")
      .max(10, "The Number must be 10 characters"),
...
const register = () => {
  ...
  return (
    <div
      style={{ backgroundImage: "url(/back_img.jpg)" }}
      className="w-full h-[100vh] pt-36"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2  w-[60%]  h-fit  mx-auto p-4 bg-white shadow-md rounded">
        <form
          onSubmit={handleSubmit(onSubmit)}
          className=" flex flex-col gap-3 px-5 py-2 com3   bg-white "
        >
          <div className=" text-center ">
            <img src="/icon.png" className="w-14 m-auto" />{" "}
            <h3 className="tp-login-title">
              {" "}
              Trading Material <span className="text-blue-500">
                Customer
              </span>{" "}
            </h3>
            <p>
          ...
          <div className="flex flex-col gap-3">
            ...
            {emailValid.message && (
              <span className="text-xs " style={{ color: emailValid.color }}>
                {emailValid.message}
              </span>
            )}
            {eer && <span className="text-xs text-red-600">{eer}</span>}
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            {per && <span className="text-xs text-red-600">{per}</span>}
          </div>
          ...
          <p>
            You agree to Trading Materials{" "}
