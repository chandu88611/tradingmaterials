  ...
  return (
    <Layout>
        ...
        <div class="row p-20">
                        ...
                        <div class="profile__tab mr-40">
                           <nav>
                              <div class="nav nav-tabs tp-tab-menu flex-column" id="profile-tab" role="tablist">
                                 <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false"><span><i class="fa-regular fa-solid fa-gauge"></i></span> Dashboard</button>
                                 <button class="nav-link" id="nav-information-tab" data-bs-toggle="tab" data-bs-target="#nav-information" type="button" role="tab" aria-controls="nav-information" aria-selected="false"><span><i class="fa-regular fa-user-pen"></i></span>Profile Information</button>
                                 <button class="nav-link" id="nav-address-tab" data-bs-toggle="tab" data-bs-target="#nav-address" type="button" role="tab" aria-controls="nav-address" aria-selected="false"><span><i class="fa-light fa-location-dot"></i></span> Saved Address </button>
                                 ...
                                 <button class="nav-link" id="nav-cart-tab" data-bs-toggle="tab" data-bs-target="#nav-cart" type="button" role="tab" aria-controls="nav-cart" aria-selected="false"><span><i class="fa-light fa-cart-shopping"></i></span> Cart </button>
                                 <button class="nav-link" id="nav-notification-tab" data-bs-toggle="tab" data-bs-target="#nav-notification" type="button" role="tab" aria-controls="nav-notification" aria-selected="false"><span><i class="fa-regular fa-timeline"></i></span> Activity</button>
                                 <button class="nav-link" id="nav-product-tab" data-bs-toggle="tab" data-bs-target="#nav-product" type="button" role="tab" aria-controls="nav-product" aria-selected="false"><span><i class="fa-regular fa-cash-register"></i></span> Product</button>
                     ...
                     <div class="col-xxl-8 col-lg-8 mt-2">
                           ...
                           <div class="tab-content" id="profile-tabContent">
                              ...
                              <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                                 <div class="profile__info">
                                    <h3 class="profile__notification-title">Personal Details</h3>
                              ...
                              <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab">
                                 <div class="profile__notification-top mb-30">
                                    <h3 class="profile__notification-title">Change Password</h3>
                                 </div>
                                 ...
                                 <div class="profile__address">
                                    <div class="row">
                                       <div class="col-lg-12 pt-10 pb-10">
                                          <button class="address-btn"><i class="fa-solid fa-plus"></i> Add Address</button>
                                       </div>
                                       <div class="col-md-6">
                              ...
                              <div class="tab-pane fade" id="nav-order" role="tabpanel" aria-labelledby="nav-order-tab">
                                 <div class="profile__notification-top mb-30">
                                    <h3 class="profile__notification-title">My Orders</h3>
                                 </div>
                                 <div class="tp-product-details-tab-nav tp-tab">
                                    <nav>
                                       <div class="nav nav-tabs p-relative tp-product-tab" id="navPresentationTab" role="tablist">
                                          <button class="nav-link active" id="recent-orders-tab" data-bs-toggle="tab" data-bs-target="#recent-orders" type="button" role="tab" aria-controls="recent-orders" aria-selected="true"><i class="fa-solid fa-calendar-days"></i> Recent</button>
                                          <button class="nav-link" id="completed-orders-tab" data-bs-toggle="tab" data-bs-target="#completed-orders" type="button" role="tab" aria-controls="completed-orders" aria-selected="false"><i class="fa-solid fa-thumbs-up"></i> Completed</button>
                                          <button class="nav-link" id="cancelled-orders-tab" data-bs-toggle="tab" data-bs-target="#cancelled-orders" type="button" role="tab" aria-controls="cancelled-orders" aria-selected="false"><i class="fa-solid fa-xmark"></i> Cancelled</button>
                                          <button class="nav-link" id="refund-orders-tab" data-bs-toggle="tab" data-bs-target="#refund-orders" type="button" role="tab" aria-controls="refund-orders" aria-selected="false"><i class="fa-solid fa-hand-holding-dollar"></i> Refund</button>
                                          <span id="productTabMarker" class="tp-product-details-tab-line"></span>
                                       </div>
                                    </nav>
                                    <div class="tab-content" id="navPresentationTabContent">
                                       <div class="tab-pane fade" id="recent-orders" role="tabpanel" aria-labelledby="recent-orders-tab" tabindex="0">
                                       ...
                                       <div class="tab-pane fade show active" id="completed-orders" role="tabpanel" aria-labelledby="completed-orders-tab" tabindex="0">
                                          <div class="tp-product-details-review-wrapper pt-60">
                                             <div class="row">
                                                <div class="col-lg-12">
                                                   <div class="profile__ticket table-responsive">
                                       ...
                                       <div class="tab-pane fade" id="cancelled-orders" role="tabpanel" aria-labelledby="cancelled-orders-tab" tabindex="0">
                                          <div class="tp-product-details-review-wrapper pt-60">
                                             <div class="row">
                                                <div class="col-lg-12">
                                                   <div class="profile__ticket table-responsive">
                                       ...
                                       <div class="tab-pane fade" id="refund-orders" role="tabpanel" aria-labelledby="refund-orders-tab" tabindex="0">
                                          <div class="tp-product-details-review-wrapper pt-60">
                                             <div class="row">
                                                <div class="col-lg-12">
                                                   <div class="profile__ticket table-responsive">
                              ...
                              <div class="tab-pane fade" id="nav-cart" role="tabpanel" aria-labelledby="nav-cart-tab">
                                 <div class="profile__notification-top mb-30">
                                    <h3 class="profile__notification-title">My Cart</h3>
                                 </div>
                                 <div class="tp-product-details-tab-nav tp-tab">
                                    <nav>
                                       <div class="nav nav-tabs p-relative tp-product-tab" id="navPresentationTab" role="tablist">
                                          <button class="nav-link active" id="current-items-tab" data-bs-toggle="tab" data-bs-target="#current-items" type="button" role="tab" aria-controls="current-items" aria-selected="true"><i class="fa-solid fa-cart-shopping"></i> Current Items</button>
                                          <button class="nav-link" id="removed-items-tab" data-bs-toggle="tab" data-bs-target="#removed-items" type="button" role="tab" aria-controls="removed-items" aria-selected="false"><i class="fa-solid fa-cart-arrow-down"></i> Removed Items</button>
                                          <button class="nav-link" id="wishlist-items-tab" data-bs-toggle="tab" data-bs-target="#wishlist-items" type="button" role="tab" aria-controls="wishlist-items" aria-selected="false"><i class="fa-solid fa-heart"></i> Wishlist</button>
                                          <span id="productTabMarker" class="tp-product-details-tab-line"></span>
                                       </div>
                                    </nav>
                                    <div class="tab-content" id="navPresentationTabContent">
                                       <div class="tab-pane fade" id="current-items" role="tabpanel" aria-labelledby="current-items-tab" tabindex="0">
                                          <div class="tp-product-details-review-wrapper pt-60">
                                             <div class="row">
                                                <div class="col-lg-12">
                                                   <div class="profile__ticket table-responsive">
                                       ...
                                       <div class="tab-pane fade show active" id="removed-items" role="tabpanel" aria-labelledby="removed-items-tab" tabindex="0">
                                          <div class="tp-product-details-review-wrapper pt-60">
                                             <div class="row">
                                                <div class="col-lg-12">
                                                   <div class="profile__ticket table-responsive">
                                       ...
                                       <div class="tab-pane fade" id="wishlist-items" role="tabpanel" aria-labelledby="wishlist-items-tab" tabindex="0">
                                          <div class="tp-product-details-review-wrapper pt-60">
                                             <div class="row">
                                                <div class="col-lg-12">
                                                   <div class="profile__ticket table-responsive">
                              ...
                              <div class="tab-pane fade" id="nav-notification" role="tabpanel" aria-labelledby="nav-notification-tab">
                                 <div class="profile__notification-top mb-30">
                                    <h3 class="profile__notification-title">Activity Log</h3>
                                 </div>
                                    ...
                                    <div class="timeline">
                                       ...
                                       <div class="event">
                                          ...
                                          <div class="event__description">
                                             <a class="event__link" href="#">Event Title1</a>
                                             Event Description
                                          </div>
                                       </div>
                                       <div class="event">
                              ...
                              <div class="tab-pane fade" id="nav-product" role="tabpanel" aria-labelledby="nav-product-tab">
                                 <div class="profile__notification-top mb-30">
                                    <h3 class="profile__notification-title">Products</h3>
                                 </div>
                                 <div class="row">
