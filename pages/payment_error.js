...
function payment_error() {
  return (
    <div>
      {" "}
      <section class="profile__area pt-25 pb-75">
        <div class="container">
          <div class="row">
            <div class="col-xxl-12">
              <div class="breadcrumb__content p-relative z-index-1 pb-20 d-flex align-items-center justify-content-between">
                ...
                <div class="profile__main-logout text-sm-end">
                  <a href="login.html" class="tp-logout-btn">
              ...
              <div class="col-lg-7 m-auto">
                <div class="profile__main shadow h-100">
                  <div class="profile__main-top p-20">
                    ...
                    <div class="">
                      <p
                        class="text-center text-danger mb-10"
                        style={{ lineHeight: 1.25 }}
                      >
                        <b>Failed!</b>
                        <br /> Oh! It Seem like a issue in this payment
                        transaction. You can try again after some time.
                      </p>
                      <div class="row">
                      ...
                      <p class="text-center text-orange mb-0 mt-15">
                        <b>Note : </b> If the amount has been debited from your
                        account it will be credited back within 5-7 working
                        days, if not kindly raise a ticket or call us at
                        XXXXXXXXXX.
                      </p>
                      <div class="text-center mt-15">
                        <a
                          href="#"
                          class="tp-btn tp-btn-2 tp-btn-blue btn-green mr-5"
                        >
                          Retry{" "}
                        </a>
                        <a
                          href="#"
                          class="tp-btn tp-btn-2 tp-btn-blue btn-orange"
                        >
                          Raise Ticket
                        </a>
                      </div>
