         ...
         <div className="offcanvas__wrapper">
            ...
            <div className="offcanvas__content">
               ...
               <div className="offcanvas__btn">
                  <a href="#" className="tp-btn-2 tp-btn-border-2">Contact Us</a>
               </div>
            </div>
                        ...
                        <div className="tp-header-top-right d-flex align-items-center justify-content-end">
                           <div className="tp-header-top-menu d-flex align-items-center justify-content-end">
                              <div className="tp-header-top-menu-item tp-header-lang">
                                 <p className="ss-tp-text"><i className="fa fa-map-marker-alt"></i> <span className="">Tamilnadu,</span> <span className="ss-tp-text-title">India</span></p>
                              </div>
                           </div>
                        </div>
                     </div>
                              ...
                              <div className="tp-header-search-wrapper d-flex align-items-center">
                                 ...
                                 <div className=" border-l-2 p-1 border-gray-600" >
                                    <select  className='outline-none p-1 border-gray-300 border-l-[1px] cursor-pointer rounded'>
                                       ...
                                       <option className='m-1'>Day Trader Mouse Pad</option>
                                       <option className='m-1'>Trading Desk Mat</option>
                                       <option className='m-1'>Candlestick Chart Patterns Posters</option>
                                       <option className='m-1'>Day Trading Journal</option>
                                       <option className='m-1'>Trading Cards</option>
                                       <option className='m-1'>Price Actions & Setup Posters</option>
                                       <option className='m-1'>Guide on Price Action</option>
                                    </select>
                                 </div>
                                 <div className="tp-header-search-btn">
                                    <button type="submit">
                                       <FaSearch size={"30px"} className='m-auto text-gray-600'/>
                                    </button>
                                 </div>
                              </div>
                           </form>
                        ...
                        <div className="tp-header-main-right d-flex align-items-center justify-content-end ">
                           <div className="tp-header-login d-none d-lg-block">
                              <a href="index.html" className="d-flex align-items-center">
                                 ...
                                 <div className="tp-header-login-content d-none d-xl-block">
                                    <span>Contact</span>
                                    <h5 className="tp-header-login-title">+91 - 9901234567</h5>
                                 </div>
                              </a>
                           </div>
                           ...
                           <div className="tp-header-action-item">
                              ...
                              <button type="button" className={`tp-header-action-btn cartmini-open-btn ${cartItems?"cart_glow":''}`} onClick={()=>checkUser("cart")}>
                                 ...
                                 <span className="tp-header-action-badge">{users?.cart_count||0}</span>                                                                          
                              </button>
                           </div>
                              ...
                              <ul>
                                 <li className="has-dropdown">
                                    ...
                                    <ul className="tp-submenu">
                                       ...
                                       <li><a href="#">Day Trader Mouse Pad</a></li>
                                       <li><a href="#">Trading Desk Mat</a></li>
                                       <li><a href="#">Candlestick Chart Patterns Posters</a></li>
                                       <li><a href="#">Day Trading Journal</a></li>
                                       <li><a href="#">Trading Cards</a></li>
                                       <li><a href="#">Price Actions & Setup Posters</a></li>
                                       <li><a href="#">Guide on Price Action</a></li>
                                    </ul>
                                 </li>
                                 ...
                                 <li className="has-dropdown">
                                    ...
                                    <ul className="tp-submenu">
                                       <li><a href="#">All Trading Materials Pack on Shop</a></li>
                                       <li><a href="#">Bundle Pack 1</a></li>
                                       <li><a href="#">Bundle Pack 2</a></li>
                                       <li><a href="#">Bundle Pack 3</a></li>
                                    </ul>
                                 </li>
                                             ...
                                             <div className="home-menu-item " >
                                                <a href="index.html">
                                                   ...
                                                   <div className="home-menu-content">
                                                      <h5 className="home-menu-title">Trading Material </h5>
                                                   </div>
                                                </a>
                                             </div>
                                          </div>
                                          <div className="col">
                                             <div className="home-menu-item ">
                                                <a href="#">
                                                   ...
                                                   <div className="home-menu-content">
                                                      <h5 className="home-menu-title">Trading Material Two</h5>
                                                   </div>
                                                </a>
                                             </div>
                                          </div>
                                          <div className="col">
                                             <div className="home-menu-item ">
                                                <a href="#">
                                                   ...
                                                   <div className="home-menu-content">
                                                      <h5 className="home-menu-title">Trading Material Three</h5>
                                                   </div>
                                                </a>
                                             </div>
                                          </div>
                                          <div className="col">
                                             <div className="home-menu-item ">
                                                <a href="#">
                                                   ...
                                                   <div className="home-menu-content">
                                                      <h5 className="home-menu-title">Trading Material Four </h5>
                                                   </div>
                                                </a>
                                             </div>
                                          </div>
                                          <div className="col">
                                             <div className="home-menu-item ">
                                                <a href="#">
                                                   ...
                                                   <div className="home-menu-content">
                                                      <h5 className="home-menu-title">Trading Material Five</h5>
                                                   </div>
                                                </a>
                                             </div>
                                          </div>
