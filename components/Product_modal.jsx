                        ...
                        <div class="tp-product-details-action-wrapper">
                           ...
                           <div class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                              ...
                              <div className="tp-product-quantity mb-15 mr-15">
                                  <span className="tp-cart-minus flex  " onClick={handleDecreaseQuantity}>
                                  <AiOutlineMinus className='m-auto'/>                                                    
                                  </span>
                                  <span className='ml-14'>  {quantity}</span> 
                                  <span className="tp-cart-plus flex" onClick={handleIncreaseQuantity}>
